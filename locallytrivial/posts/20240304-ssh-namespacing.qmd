...
description: "A guide to setting up SSH namespaces with Git, allowing you to use different SSH keys for different accounts on the same Git hosting service. This is particularly useful for developers who have both personal and work accounts on platforms like GitHub, GitLab, or Bitbucket."
date: "2024-03-04"
categories: [Code]
tags: [Git, SSH, Security]
image: ../img/key-pile-small.png
---
...
![General Flow Diagram of Git and SSH call stack.](../img/ssh-namespacing3.svg){#fig-general-flow}
...
Make sure that these keys are added to the appropriate host. The GitHub and GitLab documentation provide instructions for adding SSH keys to your account. [@github_ssh; @gitlab_ssh]
...
::: {.callout-tip}
## Note: Trailing Forward Slash in gitdir
...
This post was adapted from and inspired by several sources, with a few key changes and summary. [@vance_gist; @jacob_fcc; @russell_medium]
