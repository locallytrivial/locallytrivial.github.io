...
description: "A visual map of algebraic structures, showing the relationships between sets, magmas, groups, rings, fields, and more. This diagram helps clarify the hierarchy and connections between different algebraic objects commonly used in mathematical physics."
date: "2020-03-15"
...
vector spaces, and inner product spaces. [@jeevanjee_introduction_2015]
...
specific (and the magma more general). [@roman_advanced_2007]
...
isn't a substitute for opening Hungerford! [@hungerford_algebra_2008]
